...
export default class LoginBlock extends Component {
    ...
    render() {
        ...
        const text = () => {  return  (this.props.page == 4)  ?  'Войдите для оформления заявки'  : 'Войдите как родитель ученика ОЦ "Сириус"'}

        const nextPageLink = () => {  return this.props.page == 4  ? "/mobile/5" : "/mobile/6" };
